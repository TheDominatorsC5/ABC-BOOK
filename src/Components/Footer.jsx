...
export default function Navbar() {
  return (
    <footer className="bg-red-50">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 p-4">
          ...
          <div className="flex flex-col gap-1 p-2">
            ...
            <p className="text-gray-700 text-sm">Get the breathing space now, and we’ll extend your term at the other end year for go.</p>

            <div className="flex gap-2 items-center text-gray-700 ">
              <div className="flex justify-between items-center w-10 h-10 border-1 border-gray-200 rounded-full">
              ...
              <div className="flex justify-between items-center w-10 h-10 border-1 border-gray-200 rounded-full">
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-full lucide lucide-youtube-icon lucide-youtube"><path d="M2.5 17a24.12 24.12 0 0 1 0-10 2 2 0 0 1 1.4-1.4 49.56 49.56 0 0 1 16.2 0A2 2 0 0 1 21.5 7a24.12 24.12 0 0 1 0 10 2 2 0 0 1-1.4 1.4 49.55 49.55 0 0 1-16.2 0A2 2 0 0 1 2.5 17" /><path d="m10 15 5-3-5-3z" /></svg></div>
            </div>
          </div>
      ...
      <p className="p-3 text-center text-xs mt-10 text-black">Non Copyrighted© 2025 Upload by ABC Books</p>
